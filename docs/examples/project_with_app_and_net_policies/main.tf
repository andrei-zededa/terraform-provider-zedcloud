...
# In most enterprises, even those without any previous configurare a datastore
# named `Dockerhub` should exists. We can either use a data block or import it,
# e.g. `terraform import zedcloud_datastore.Dockerhub 8d2d605d-7d3e-4c45-aadb-572ffbc5a9de`.
...
resource "zedcloud_project" "PROJ_ABCDEF0123_FROM_TF" {
  name  = "PROJ_ABCDEF0123_FROM_TF"
  title = "Project ABCDEF0123 created via terraform"
  ...
  app_policy {
    ...
    name  = "PROJ_ABCDEF0123_FROM_TF.apppolicy"
    title = ""
    ...
    app_policy {
      apps {
        ...
        name_project_part = "PROJ_ABCDEF0123_FROM_TF"
  ...
  network_policy {
    ...
    name  = "PROJ_ABCDEF0123_FROM_TF.networkPolicy"
    title = ""
...
resource "zedcloud_network" "edge_node_as_dhcp_client" {
  name  = "edge_node_as_dhcp_client_PROJ_ABCDEF0123"
  title = "edge_node_as_dhcp_client_PROJ_ABCDEF0123"
  kind  = "NETWORK_KIND_V4"

  depends_on = [
    zedcloud_project.PROJ_ABCDEF0123_FROM_TF
  ]

  project_id = zedcloud_project.PROJ_ABCDEF0123_FROM_TF.id
...
resource "zedcloud_edgenode" "EDGE_NODE_ABCDEF0123_FROM_TF" {
  name           = "EDGE_NODE_ABCDEF0123_FROM_TF"
  title          = "EDGE_NODE_ABCDEF0123_FROM_TF"
  serialno       = "ABCDEF0123"
